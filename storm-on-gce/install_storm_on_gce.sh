...
# Configuration
#
GCE_PROJECT=idyllic-physics-171716
GCE_ZONE=us-east1-b
...
function setup_zk() {
  ...
  sleep 3
  gcloud --project=storm-simple addfirewall zk --description="Allow ZK" --allowed=":2181" --print_json
...
function setup_nimbus() {
  ...
  sleep 3
  gcloud --project=storm-simple addfirewall nimbus --description="Allow Nimbus" --allowed=":6627" --print_json
  gcloud --project=storm-simple addfirewall nimbusui --description="Allow Nimbus UI" --allowed=":8080" --print_json
...
##gcloud --project=storm-simple addfirewall supervisor1 --description="Allow Supervisor" --allowed=":6700" --print_json
##gcloud --project=storm-simple addfirewall supervisor2 --description="Allow Supervisor" --allowed=":6701" --print_json
